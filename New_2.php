...
<center>
<h1>Impiortant Notice ! ! !</h1>
<br>
<h3>
Please do not use an special characters when filling in the form.<br>
This includes commas. and these symbols: <br/><br/>
&#33;
&#34;
&#35;
&#36;
...
<br/>
 <input type="radio" name="agentname" <?php if (isset($agentname) && $agentname == "Moeniba") echo "checked";?>" value="Moeniba">Moeniba
...
<br/> 
 ...
 <input type="text" name="per_id" value="<?php echo $per_id; ?>" />
 </td></tr>
</table>
...
<i>NB!!! Format: YYYY-MM-DD (2016-08-24)</i><br> 
 ...
 <input type="text" name="emp_travelallow" value="<?php echo $emp_travelallow; ?>" />
 </td></tr>
 
  <tr><td>
 <strong>Petrol Allowance:</strong>
 </td><td>
 <input type="text" name="emp_petrallow" value="<?php echo $emp_petrallow; ?>" />
 </td></tr>
 
  <tr><td>
 <strong>Overtime:</strong>
 </td><td>
 <input type="text" name="emp_overtime" value="<?php echo $emp_overtime; ?>" />
 </td></tr>
 
  <tr><td>
 <strong>Commission:</strong>
 </td><td>
 <input type="text" name="emp_comm" value="<?php echo $emp_comm; ?>" />
 </td></tr>
...
<input type="text" name="bank_br" value="<?php echo $bank_br; ?>" />
 ...
 <input type="text" name="fin_veh" value="<?php echo $fin_veh; ?>" />
 </td></tr>
 
     <tr><td>
 <strong>Overdraft:</strong>
 </td><td>
 <input type="text" name="fin_overd" value="<?php echo $fin_overd; ?>" />
 </td></tr>
 
     <tr><td>
 <strong>Clothing Accounts:</strong>
 </td><td>
 <input type="text" name="fin_cloth" value="<?php echo $fin_cloth; ?>" />
 </td></tr>
 
     <tr><td>
 <strong>Credit Cards:</strong>
 </td><td>
 <input type="text" name="fin_ccards" value="<?php echo $fin_ccards; ?>" />
 </td></tr>
 
     <tr><td>
 <strong>Personal Loans:</strong>
 </td><td>
 <input type="text" name="fin_ploans" value="<?php echo $fin_ploans; ?>" />
 </td></tr>
